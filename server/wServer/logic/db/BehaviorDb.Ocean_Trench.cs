        ...
        private _ Ocean_Trench = () => Behav()
           ...
           new State(
            ...
            new State("Attack2",
             ...
             new Threshold(0.01,
              new ItemLoot("Coral Bow", 0.02),
              new ItemLoot("Coral Venom Trap", 0.03),
              new ItemLoot("Coral Silk Armor", 0.025),
           ...
           .Init("Sea Horse",
                 new State(
                     new State(
                         ...
                         new Shoot(7, count: 2, shootAngle: 10, coolDown: 880)
          ...
          .Init("Sea Mare",
                 new State(
                     ...
                     new Shoot(5, count: 3, shootAngle: 120, coolDown: 800),
                     new Shoot(3, count: 1, projectileIndex: 1, shootAngle: 0, coolDown: 1900)
             )//,
              //                new Threshold(0.2,
            ...
            .Init("Giant Squid",
                 new State(
                     ...
                     new TossObject("Ink Bubble", 7, angle: null, maxDensity: 2, densityRange: 20, coolDown: 1000)

             ))
          .Init("Ink Bubble",
                 new State(
                     new Shoot(1, count: 1, shootAngle: 0, coolDown: 350)
                     ))
          .Init("Sea Slurp Home",
                 new State(
                     new Shoot(4, count: 8, shootAngle: 45, coolDown: 700),
                     new Shoot(2, count: 8, shootAngle: 45, projectileIndex: 1, coolDown: 700),
                     new Spawn("Grey Sea Slurp", 7, coolDown: 1000)
                     ))
         .Init("Grey Sea Slurp",
                 new State(
                     new State(
