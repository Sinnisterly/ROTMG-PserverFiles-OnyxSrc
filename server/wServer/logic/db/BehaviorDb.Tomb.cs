        ...
        private _ Tomb = () => Behav()
            .Init("Tomb Defender",
                new State(
                    ...
                    new Threshold(0.1,
                        ...
                        new ItemLoot("Desert Blade", 0.006),
                        new ItemLoot("Stone Amulet", 0.005),
                        new ItemLoot("Sandstone Shield", 0.007),
                        new ItemLoot("Sandstone Breastplate", 0.005),
            ...
            .Init("Tomb Support",
                                ...
                                new Threshold(0.01,
                                        ...
                                        new ItemLoot("Vanguards Bow", 0.008),
                                        new ItemLoot("Torch of the Fallen", 0.008),
                                        new ItemLoot("Attacking Quiver", 0.008),
                                        new ItemLoot("Guards Armor", 0.008),
