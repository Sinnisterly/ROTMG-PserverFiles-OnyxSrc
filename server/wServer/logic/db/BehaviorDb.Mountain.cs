        ...
        private _ Mountain = () => Behav()
             .Init("Thunder God",
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Greater Potion of Attack", 0.008),
                    new ItemLoot("Potion of Attack", 0.18)
                )
            )
            ...
            .Init("Arena Headless Horseman",
                new State(
                    new DropPortalOnDeath("Haunted Cemetery Portal", .30),
                ...
                new Threshold(0.07,
                    new ItemLoot("Potion of Defense", .07)

                    )
            )
            .Init("White Demon",
                new State(
                    new DropPortalOnDeath("Abyss of Demons Portal", .15),
                    new Prioritize(
                        new StayAbove(1, 200),
                ...
                new Threshold(0.07,
                    new ItemLoot("50 gold", 0.05),
                    new ItemLoot("100 gold", 0.05),
                    new ItemLoot("Greater Potion of Attack", .04),
                    new ItemLoot("Potion of Attack", .07)
            ...
            .Init("Medusa",
                new State(
                    new DropPortalOnDeath("Snake Pit Portal", .15),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
                ...
                new Threshold(0.07,
                    new ItemLoot("50 gold", 0.05),
                    new ItemLoot("100 gold", 0.05),
                    new ItemLoot("Greater Potion of Speed", .04),
                    new ItemLoot("Potion of Speed", .07)
            ...
            .Init("Ent God",
                new State(
                    new DropPortalOnDeath("Vampire Underling Portal", .15),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
                ...
                new Threshold(0.07,
                    new ItemLoot("50 gold", 0.05),
                    new ItemLoot("100 gold", 0.05),
                    new ItemLoot("Greater Potion of Defense", .04),
                    new ItemLoot("Potion of Defense", .07)
            ...
            .Init("Beholder",
                new State(
                    new DropPortalOnDeath("Phantom Lord Portal", .15),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
            ...
            .Init("Flying Brain",
                new State(
                    ...
                    new Reproduce(densityMax: 3),
                    new DropPortalOnDeath("Mad Lab Portal", .15)
                    ),
            ...
            .Init("Slime God",
                new State(
                    new DropPortalOnDeath("Renewed Sewers Portal", .15),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
            ...
            .Init("Ghost God",
                new State(
                    ...
                    new Reproduce(densityMax: 3),
                    new DropPortalOnDeath("Undead Lair Portal", .15)
                    ),
            ...
            .Init("Leviathan",
                new State(
                    new DropPortalOnDeath("Puppet Theatre Portal", .25),
                    new State("Wander",
                        new Swirl(),
