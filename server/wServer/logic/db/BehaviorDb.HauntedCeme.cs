    ...
    partial class BehaviorDb
    {
        ...
        //Arena 1
            .Init("Arena Skeleton",
             ...
             .Init("Arena Mushroom",
                        new State(
                    new State("Mush1",
                        new TimedTransition(2000, "Mush2"),
                        new HpLessTransition(0.75, "Mush2")
                        ),
                    new State("Mush2",
                        new SetAltTexture(1),
                        new TimedTransition(2000, "Mush3"),
                      ...
                      new State("Mush3",
                       ...
                       new State("die",
                           new Shoot(8.4, 8, 360 / 8, projectileIndex: 0, coolDown: 1000),
                       new Suicide()
                        )
                )
            )
       ...
       .Init("Arena Ghost Bride",
        ...
        //Arena 3
                ...
                new ItemLoot("Dragonsoul Sword", 0.01),
        ...
        new RemoveEntity(9999, "Flying Flame Skull"),
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Potion of Wisdom", 0.5),
                    new ItemLoot("Greater Potion of Vitality", .05),
                    new ItemLoot("Greater Potion of Wisdom", 0.05),
                    new ItemLoot("Vampire Sabre", 0.005),
