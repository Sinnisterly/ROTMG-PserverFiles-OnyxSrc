    ...
    partial class BehaviorDb
    {
        private _ LairOfDraconis = () => Behav()
         ...
         .Init("Ivory Taskmaster 22",
            new State(
                new DropPortalOnDeath("Ivory Wyvern Portal", 0.5, 120),
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("idle",
        ...
        .Init("NM Green Dragon Shield",
              ...
              .Init("lod Mirror Wyvern1",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new Shoot(8.4, count: 1, projectileIndex: 0, coolDown: 600)
                    )
            )
        ...
        .Init("NM Red Dragon God",
            ...
            .Init("lod Ivory Wyvern",
                new State(
                   ...
                   new State("talk3",
                    ...
                    new State("Mirrors",
                        ...
                        new Shoot(12, count: 7, shootAngle: 16, projectileIndex: 0, coolDown: 1500),
                ...
                new Threshold(0.15,
                    new ItemLoot("Potion of Dexterity", 0.532),
                    new ItemLoot("Potion of Wisdom", 0.579),
                    new TierLoot(12, ItemType.Weapon, 0.065),
                    new TierLoot(12, ItemType.Weapon, 0.055),
                    new TierLoot(6, ItemType.Ability, 0.065),
                    new TierLoot(5, ItemType.Ability, 0.0685),
                    new TierLoot(13, ItemType.Armor, 0.0525),
                    new ItemLoot("Midnight Star", 0.025),
                    new ItemLoot("50 gold", 0.25),
                    new ItemLoot("100 gold", 0.25),
                    new ItemLoot("Large Ivory Dragon Scale Cloth", 0.0809),
                    new ItemLoot("Small Ivory Dragon Scale Cloth", 0.0824)
            )
            )
;
    }
