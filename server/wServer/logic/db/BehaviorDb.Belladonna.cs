        ...
        private _ Belladonna = () => Behav()
            ...
            .Init("vlntns Loot Balloon Bella",
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Diamond Bladed Katana", 0.2),
                    new ItemLoot("Cupid's Bow", 0.2),
                    new ItemLoot("Staff of Adoration", 0.2),
                    new ItemLoot("50 gold", 0.25),
                    new ItemLoot("100 gold", 0.25),
                    new ItemLoot("Wand of Budding Romance", 0.2),
                    new ItemLoot("Heartfind Dagger", 0.2),
                    new ItemLoot("Vinesword", 0.2)
                )
            );
    }
}