        ...
        private _ Abyss = () => Behav()
            .Init("Archdemon Malphas",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Ember Blade", 0.008),
                    new ItemLoot("Ember Helmet", 0.009),
                    new ItemLoot("Ember Armor", 0.007),
                    new ItemLoot("The Ember Pendant", 0.01),
                    new ItemLoot("Rose of Flames", 0.008),
                    new ItemLoot("Abyssal Flames Spell", 0.01),
                    new ItemLoot("Robes of the Abyss", 0.008),
                    new ItemLoot("Malphas Respite", 0.007),
                    new ItemLoot("Potion of Vitality", 1.0),
                    new ItemLoot("Potion of Defense", 0.2),
                    new ItemLoot("50 gold", 0.25),
                    new ItemLoot("100 gold", 0.25),
                    new ItemLoot("Greater Potion of Defense", .05),
                    new ItemLoot("Greater Potion of Attack", 0.05),
