        ...
        private _ UndeadLair = () => Behav()
            .Init("Septavius the Ghost God",
                new State(
                    ...
                    new State("spiral",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable, false, 6000),
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Ring of Darkness", 0.007),
                    new ItemLoot("Nightmare Fuel", 0.006),
                    new ItemLoot("Lost Souls", 0.006),
                    new ItemLoot("Platemail of the Gods", 0.005),
                    new ItemLoot("Bow of Horrors", 0.006),
                    new ItemLoot("Phantom Blade", 0.005),
                    new ItemLoot("Immovable Shield", 0.005),
                    new ItemLoot("Ghastly Armor", 0.007),
