...
namespace wServer.realm.entities
{
    public enum MarketResult
    {
        ...
        NullItem,
        [Description("Not enough gold. There is a 5 gold fee to remove that item.")]
        InsufficientFunds,
    ...
    public partial class Player
    {
        ...
        public MarketResult AddToMarket(int slot, int price)
        {
            ...
            if (acc.Admin && acc.Rank < 0 || !Manager.Config.serverSettings.enableMarket)
