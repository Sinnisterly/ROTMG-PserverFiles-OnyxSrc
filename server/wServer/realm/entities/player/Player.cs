    ...
    public partial class Player : Character, IContainer, IPlayer
    {
       ...
       // {
        ...
        public override void Tick(RealmTime time)
        {
            ...
            var gameData = Manager.Resources.GameData;
            #region Ember Blade
            if (Inventory[0] == gameData.Items[0x6446])
            {
                var generate = Random.Next(1, 200);
            ...
            #region Rose Staff
            if (Inventory[0] == gameData.Items[0x2829])
            {
                var generate = Random.Next(1, 200);

                if (generate == 5)
                {
                    ApplyConditionEffect(ConditionEffectIndex.Speedy, 2000);
                    BroadcastSync(new Notification()
                    {
                        ObjectId = Id,
                        Color = new ARGB(0x66fa67),
                        Message = "Lively"
                    }, p => this.DistSqr(p) < RadiusSqr);
                }
            }
            ...
            #region Ember Helm
            if (Inventory[1] == gameData.Items[0x8331])
            {
                var generate = Random.Next(1, 400);
            ...
            #region Icicle
            if (Inventory[0] == gameData.Items[0x4779])
            {
                var generate = Random.Next(1, 300);

                if (generate == 5)
                {
                    ApplyConditionEffect(ConditionEffectIndex.Berserk, 2000);
                    BroadcastSync(new Notification()
                    {
                        ObjectId = Id,
                        Color = new ARGB(0xe93b26),
                        Message = "Efficient"
                    }, p => this.DistSqr(p) < RadiusSqr);
                }
            }
            ...
            #region Seal of the Rat
            if (Inventory[1] == gameData.Items[0x5406])
            {
                var generate = Random.Next(1, 1000);

                if (generate == 5)
                {
                    ApplyConditionEffect(ConditionEffectIndex.Hexed, 1500);
                    BroadcastSync(new Notification()
                    {
                        ObjectId = Id,
                        Color = new ARGB(0x3b1740),
                        Message = "Hexed"
                    }, p => this.DistSqr(p) < RadiusSqr);
                }
            }
            ...
            #region Lost Souls
            if (Inventory[3] == gameData.Items[0x3419])
            {
                var generate = Random.Next(1, 1000);

                if (generate == 5)
                {
                    ApplyConditionEffect(ConditionEffectIndex.Quiet, 1500);
                    BroadcastSync(new Notification()
                    {
                        ObjectId = Id,
                        Color = new ARGB(0x8ad5e9),
                        Message = "Silenced"
                    }, p => this.DistSqr(p) < RadiusSqr);
                }
            }
            ...
            #region Tome of Sins
            if (Inventory[1] == gameData.Items[0x5125])
            {
                var generate = Random.Next(1, 300);

                if (generate == 5)
                {
                    ApplyConditionEffect(ConditionEffectIndex.Healing, 2500);
                    BroadcastSync(new Notification()
                    {
                        ObjectId = Id,
                        Color = new ARGB(0xee3a2f),
                        Message = "Healed"
                    }, p => this.DistSqr(p) < RadiusSqr);
                }
            }
            ...
            #region Binding Stone
            if (Inventory[3] == gameData.Items[0x4138])
            {
                var generate = Random.Next(1, 1000);

                if (generate == 5)
                {
                    ApplyConditionEffect(ConditionEffectIndex.Curse, 1500);
                    BroadcastSync(new Notification()
                    {
                        ObjectId = Id,
                        Color = new ARGB(0xff0000),
