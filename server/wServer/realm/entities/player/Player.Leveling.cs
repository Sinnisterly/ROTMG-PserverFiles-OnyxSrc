...
namespace wServer.realm.entities
{
    public partial class Player
    {
            ...
            new Dictionary<string, Tuple<int, int, int>>()  //Priority, Min, Max
        {
            ...
            { "Warrior Bee",                    Tuple.Create(8, 8, 20) }, //Mid Plains
            ...
            { "Red Demon",                      Tuple.Create(13,15, 20) },
                ...
                // events
            //{ "Queen of Hearts",                Tuple.Create(14,15, 20) },
            ...
            { "rs GoldenRat",                   Tuple.Create(15,1, 20) }, //Renewed Sewers
            { "TH Queen Bee",                   Tuple.Create(15,1, 20) }, //The Hive
