...
namespace wServer.realm.setpieces
{
    partial class SetPieces
    {
        ...
        static readonly List<Tuple<ISetPiece, int, int, WmapTerrain[]>> setPieces = new List<Tuple<ISetPiece, int, int, WmapTerrain[]>>()
        {
            ...
            SetPiece(new Warrior_Bee(), 10, 20, WmapTerrain.MidPlains),
            ...
            SetPiece(new BeerGod(), 0, 5, WmapTerrain.HighPlains, WmapTerrain.HighForest),
            ...
            //GLANDS 'GREATER' MOBS
            SetPiece(new Headless_Horseman(), 5, 15, WmapTerrain.Mountains)
        };
