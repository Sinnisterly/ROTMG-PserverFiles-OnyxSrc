...
namespace wServer.realm
{
    ...
    class Oryx
    {
        ...
        {
            Tuple.Create("Skull Shrine", (ISetPiece) new SkullShrine()),                  //Orb of Conflict     Flaming Boomerang
            Tuple.Create("Cube God", (ISetPiece) new CubeGod()),                          //Cronus Dagger       Skull of the Cubes
            Tuple.Create("Pentaract", (ISetPiece) new Pentaract()),                       //Seal of the Blasphemous Prayer
            Tuple.Create("Grand Sphinx", (ISetPiece) new Sphinx()),                       //Helm of the Juggernaut
            Tuple.Create("Lord of the Lost Lands", (ISetPiece) new LordoftheLostLands()), //Shield of Ogmur
            Tuple.Create("Hermit God", (ISetPiece) new Hermit()),                         //Helm of the Juggernaut
            Tuple.Create("Ghost Ship", (ISetPiece) new GhostShip()),                      //Thirsty Ghost Trap
            Tuple.Create("Dragon Head", (ISetPiece) new RockDragon()),                    //Ray Katana
            Tuple.Create("shtrs Defense System", (ISetPiece) new Avatar()),                //Tablet of the King's avatar
            Tuple.Create("Reborn Flower", (ISetPiece) new RebornFlower()),                //Tablet of the King's avatar
            Tuple.Create("Queen of Hearts", (ISetPiece) new QueenRealm())               //QueensHead        Card Armor
            //Tuple.Create("Fanatic of Chaos", (ISetPiece) new FanaticofChaos())           //Seal of the Fanatic
        };
        ...
        private static readonly Tuple<string, TauntData>[] CriticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            Tuple.Create("Reborn Flower", new TauntData()
            {
                Spawn = new string[] {
                    "My Reborn Flower will teach you to respect nature!"
                },
                Killed = new string[] {
                    "The Flowers have bloomed! Minions, to arms!",
                    "{PLAYER} Shall certainly be killed! Come on!"
                }
            }),
