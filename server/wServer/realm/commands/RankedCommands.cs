...
namespace wServer.realm.commands
{
    class SpawnCommand : Command
    {
        ...
        public SpawnCommand() : base("spawn", permLevel: 80, alias: "s") { }
    ...
    class SpawnBCommand : Command
    {
        ...
        public SpawnBCommand() : base("spawnb", alias:"sb", permLevel: 100) { }
    ...
    {
        public ToggleEffCommand() : base("eff", alias:"addeff", permLevel: 80) { }
    ...
    /*class DonoGimmeCommand : Command
    {
        public DonoGimmeCommand() : base("dgimme", permLevel: 60, alias: "dgive") { }
        ...
        protected override bool Process(Player player, RealmTime time, string args)
        {
            ...
            ushort objType;
            if (player.Client.Account.Rank < 100 &&
                (gameData = (Object.Contains.Soulbound
                )
                )
            // allow both DisplayId and Id for query
            if (!gameData.DisplayIdToObjectType.TryGetValue(args, out objType))
            ...
            #region Banned Items
                 item.DisplayName.Equals("Boshy Gun") ||
                 item.DisplayName.Equals("10 Gold") ||
                 item.DisplayName.Equals("20 Gold") ||
                 item.DisplayName.Equals("40 Gold") ||
                 item.DisplayName.Equals("50 Gold") ||
                 item.DisplayName.Equals("100 Gold") ||
                 item.DisplayName.Equals("Boshy Shotgun") ||
                 item.DisplayName.Equals("50 Fame") ||
                 item.DisplayName.Equals("100 Fame") ||
                 item.DisplayName.Equals("500 Fame") ||
    ...
    {
        public TpPosCommand() : base("tpPos", permLevel: 60, alias: "goto") { }
    ...
    {
        public OryxSayCommand() : base("oryxSay", permLevel: 60, alias: "osay") { }
    ...
    class DonatorIsle : Command
    {
        public DonatorIsle() : base("donator", alias:"isle", permLevel: 10) { }
    ...
    {
        public KillPlayerCommand() : base("killPlayer", alias:"kill", permLevel: 100) { }
    ...
    {
        public ReSkinCommand() : base("reskin", permLevel: 50) { }
    ...
    {
        public TpQuestCommand() : base("tq", permLevel: 60) { }
    ...
    {
        public ClearInvCommand() : base("clearinv", permLevel: 60) { }
    ...
    class QuakeBCommand : Command
    {
        public QuakeBCommand() : base("quakeb", alias: "qb", permLevel: 100) { }
    ...
    {
        public VisitCommand() : base("visit", permLevel: 60) { }
    ...
    {
        public Level20Command() : base("level20", permLevel: 40, alias: "l20") { }
