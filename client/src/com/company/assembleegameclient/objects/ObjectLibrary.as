...
public class ObjectLibrary {
    ...
    public static function getRedrawnTextureFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5):BitmapData {
        ...
        if (_local8 == null && _local9.hasOwnProperty("@legendary")) {
            return TextureRedrawer.redraw(_local6, _arg2, _arg3, 0xFFE700, _arg4, _arg5);
        }
        if (_local8 == null && _local9.hasOwnProperty("AdminGlow")) {
            return TextureRedrawer.redraw(_local6, _arg2, _arg3, 0xff0000, _arg4, _arg5);
        }
            if (_local8 == null && _local9.hasOwnProperty("AscendedGlow")) {
                return TextureRedrawer.redraw(_local6, _arg2, _arg3, 0xE72300, _arg4, _arg5);
        }
        if (_local8 == null && _local9.hasOwnProperty("AncientGlow")) {
            return TextureRedrawer.redraw(_local6, _arg2, _arg3, 0x00E7B3, _arg4, _arg5);
        }
            if (_local8 == null && _local9.hasOwnProperty("LegendaryGlow")) {
                return TextureRedrawer.redraw(_local6, _arg2, _arg3, 0xFFE700, _arg4, _arg5);
            }
    ...
    public static function getTier(_arg1:int):String {
    ...
    public static function getTierType(_arg1:String):int {
        switch (_arg1) {
            case "Regular":
                return 0xffffff;
            case "Untiered":
    ...
    public static function getTierColoring(_arg1:int):int {
        return getTierType(getTier(_arg1));
