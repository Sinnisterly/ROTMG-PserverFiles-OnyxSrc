...
public class ConditionEffect {
    ...
    //Exposed
    //public static const EXPOSED:uint = 51;
    //public static const EXPOSED_IMMUNE:uint = 52;
    //public static const EXPOSED_BIT:uint = (1 << (EXPOSED - 1));
    //public static const EXPOSED_IMMUNE_BIT:uint = (1 << (EXPOSED_IMMUNE - NEW_CON_THREASHOLD));
    ...
    public static var effects_:Vector.<ConditionEffect> =
            new <ConditionEffect>[
                ...
                //new ConditionEffect("Exposed", EXPOSED_BIT, [51], "Exposed")
            ];
