...
public class AssetLoader {
    ...
    private function addImages():void {
        ...
        AssetLibrary.addImageSet("lofiObjBig2", new EmbeddedAssets.lofiObjBig2Embed_().bitmapData, 16, 16);
    ...
    private function addAnimatedCharacters():void {
        ...
        AnimatedChars.add("chars16x16zEncounters", new EmbeddedAssets.chars16x16zEncountersEmbed_().bitmapData, null, 16, 16, 112, 16, AnimatedChar.RIGHT);
