...
public class NewCharacterScreen extends Sprite {
    ...
    public function initialize(_arg1:PlayerModel):void {
        ...
        this.creditDisplay_.draw(_arg1.getCredits(), _arg1.getFame()/*, _arg1.getGems()*/);
    ...
    public function updateCreditsAndFame(_arg1:int, _arg2:int/*, _arg3:int*/):void {
        this.creditDisplay_.draw(_arg1, _arg2/*, _arg3*/);
    }
