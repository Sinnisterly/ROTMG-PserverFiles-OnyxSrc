...
public class CreditDisplay extends Sprite {
    ...
    public function CreditDisplay(_arg1:GameSprite = null, _arg2:Boolean = true, _arg3:Boolean = false, _arg4:Number = 0) {
        ...
        //this.GemsText = this.makeTextField();
        //waiter.push(this.GemsText.textChanged);
        //addChild(this.GemsText);
        //this.GemsIcon = new Bitmap(IconFactory.makeGems());
        //addChild(this.GemsIcon);
    ...
    private function onAlignHorizontal():void {
        if (this.displayFortune_) {
            ...
            //this.GemsIcon.x = (this.fortuneIcon_.x);
            //this.GemsIcon.y = (this.fortuneIcon_.y + 20);
            //this.GemsIcon.x = ((this.GemsIcon.x - this.GemsIcon.width) - 2);
            //this.GemsIcon.y = ((this.GemsIcon.y + (this.GemsIcon.height / 2)) - (this.GemsIcon.height / 2));
        }
        else {
            this.coinIcon_.x = -(this.coinIcon_.width);
            this.creditsText_.x = ((this.coinIcon_.x - this.creditsText_.width) + 8);
        ...
        if (this.displayFame_) {
            ...
            //this.GemsIcon.x = (this.fameIcon_.x + 10);
            //this.GemsIcon.y = (this.fameIcon_.y + 30);
            //this.GemsText.x = ((this.GemsIcon.x - this.GemsText.width) - 2);
            //this.GemsText.y = ((this.GemsIcon.y + (this.GemsIcon.height / 2)) - (this.GemsText.height / 2));
        }
    }
    ...
    public function draw(_arg1:int, _arg2:int, _arg3:int = 0, _arg4:int = 0):void {
        if (this.displayFortune_) {
