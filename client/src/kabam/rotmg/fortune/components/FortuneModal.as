...
public class FortuneModal extends EmptyFrame {
    ...
    public function FortuneModal(_arg1:GameSprite = null) {
        ...
        if (_local3 != null) {
            this.creditDisplay_.draw(_local3.credits_, 0, _local3.tokens_/*, _local3.Gems_*/);
        }
        if (_arg1 != null) {
            this.gs_ = _arg1;
    ...
    private function onItemSwitch(_arg1:TimerEvent = null):void {
        ...
        if (((!((this.creditDisplay_ == null))) && (!((_local4 == null))))) {
            this.creditDisplay_.draw(_local4.credits_, 0, _local4.tokens_/*, _local4.Gems_*/);
        }
    }
        ...
        if ((((this.state == STATE_ROUND_1)) && (!(this.client.requestInProgress())))) {
            ...
            if (_local2 != null) {
                if (this.boughtWithGold) {
                    ...
                    this.creditDisplay_.draw(_local2.credits_, 0, _local2.tokens_/*, _local2.Gems_*/);
                }
                else {
